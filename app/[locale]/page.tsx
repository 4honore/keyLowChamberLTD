      ...
      <section className="relative bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 text-white py-24 md:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white whitespace-pre-line">
              {t('hero.title')}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-3">{t('whyChooseUs.expertise.title')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-3">{t('whyChooseUs.service.title')}</h3>
              <p className="text-gray-600">
                {t('whyChooseUs.service.description')}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-3">{t('whyChooseUs.clientFocused.title')}</h3>
              <p className="text-gray-600">
                {t('whyChooseUs.clientFocused.description')}
              </p>
            </div>
          </div>
        </div>
