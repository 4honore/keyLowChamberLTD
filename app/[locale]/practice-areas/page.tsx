...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const t = await getTranslations({ locale, namespace: 'PracticeAreasPage.metadata' });
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">{t('approach.title')}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-gray-50 p-8 rounded-lg">
                            ...
                            <h3 className="text-xl font-semibold mb-3">{t('approach.strategic.title')}</h3>
                            <p className="text-gray-600">
                                {t('approach.strategic.description')}
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 p-8 rounded-lg">
                            ...
                            <h3 className="text-xl font-semibold mb-3">{t('approach.communication.title')}</h3>
                            <p className="text-gray-600">
                                {t('approach.communication.description')}
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 p-8 rounded-lg">
                            ...
                            <h3 className="text-xl font-semibold mb-3">{t('approach.results.title')}</h3>
                            <p className="text-gray-600">
                                {t('approach.results.description')}
                            </p>
                        </div>
                    </div>
                </div>
